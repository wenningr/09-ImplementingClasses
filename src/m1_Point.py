...
class Point(object):
    ...
    def __init__(self, x, y):
        "Init gives values to that instance variables"
        self.x = x
        self.y = y
        self.total = 0
        self.a = x
    ...
    def move_to(self, x, y):
        ...
        self.distance1 = math.sqrt((self.x-self.a)**2+(self.y-self.b)**2)
    ...
    def move_by(self, dx, dy):
        ...
        self.y = self.y + dy
        self.total = self.total + 1
        self.distance2 = math.sqrt((self.x-self.a)**2+(self.y-self.b)**2)

    def get_number_of_moves_made(self):
        return self.total

    def get_distance_from(self, another_point):
        self.distance = math.sqrt((self.x- another_point.x)**2+ (self.y-another_point.y)**2)
        return self.distance

    def get_distance_from_start(self):
        total_distance = math.sqrt((self.x-self.a)**2+(self.y-self.b)**2)
        return total_distance

    def get_distance_traveled(self):
        total_distance = self.distance1 + self.distance2
        return total_distance
